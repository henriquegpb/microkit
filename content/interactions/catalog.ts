...
.see-more-swap-button:focus-visible {
  ...
  { id: "neon-invert-button", name: "Neon Invert Button", category: "Click feedback", framework: "CSS", type: "Hover", description: "A bold orange CTA that inverts into a dark, softly glowing surface on hover.", new: true, code: `export function NeonInvertButton() {
  return (
