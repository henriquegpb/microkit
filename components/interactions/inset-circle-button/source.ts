...
.inset-circle-button { position: relative; display: grid; width: 128px; height: 128px; place-items: center; overflow: hidden; border: 1px solid light-dark(#d2d7de,#f0f0f0); border-radius: 50%; background: light-dark(#ffffff,#1f1f1f); color: light-dark(#14181e,#111); cursor: pointer; }
...
.inset-circle-button > span:last-child { position: absolute; inset: 4px; border-radius: 50%; background: light-dark(#d2d7de,#f0f0f0); clip-path: circle(75% at 50% 50%); will-change: clip-path; transition: clip-path .52s cubic-bezier(.16, 1, .3, 1); }
.inset-circle-button:hover > span:first-child, .inset-circle-button:focus-visible > span:first-child { color: light-dark(#d2d7de,#f0f0f0); }
