...
.whats-new-button { --glow-x: 50%; position: relative; display: inline-flex; align-items: center; justify-content: center; min-height: 42px; overflow: hidden; border: 1px solid light-dark(#cbd2dc,#36383d); border-radius: 999px; background: light-dark(#f6f7f9,#0e0e10); padding: 0 18px; color: light-dark(#14181e,#f0f0f0); font-size: 16px; font-weight: 500; }
