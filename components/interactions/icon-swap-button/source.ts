...
.icon-swap-button:hover .icon-swap-icon,
.icon-swap-button:focus-visible .icon-swap-icon {
  width: 0;
  margin-right: -8px;
  opacity: 0;
  transform: translateX(-18px);
}
.icon-swap-button:hover .icon-swap-arrow,
.icon-swap-button:focus-visible .icon-swap-arrow {
  width: 24px;
  margin-left: 0;
  opacity: 1;
  transform: translateX(0);
}
.icon-swap-button:focus-visible {
...
export function IconSwapButton() {
  return (
    <button type="button" className="group inline-flex min-h-14 w-[228px] items-center justify-center overflow-hidden rounded-xl border border-[#ffffff14] bg-transparent px-4 py-2 text-[#f0f0f0] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-[3px] focus-visible:outline-[#f97316]">
