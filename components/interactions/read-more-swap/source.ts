...
/* read-more-swap.css */
.read-more-swap { display: inline-flex; align-items: center; gap: 12px; height: 48px; border: 0; overflow: hidden; background: transparent; color: light-dark(#14181e,#f0f0f0); font-size: 16px; font-weight: 500; }
