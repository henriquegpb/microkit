...
.staggered-letter-glow-button {
  ...
  border: 1px solid light-dark(#adb6c3,#48484f);
  border-radius: 999px;
  background: light-dark(#ffffff,#15151b);
  padding: 0;
  color: light-dark(#14181e,#fff8f3);
...
.staggered-letter-glow-button:focus-visible {
  border-color: #f97316;
  background: light-dark(#f0f2f5,#18181e);
...
export function StaggeredLetterGlowButton() {
  return (
    <button type="button" aria-label={LABEL} className="group relative isolate inline-flex h-[54px] w-[min(190px,calc(100vw_-_40px))] cursor-pointer appearance-none items-center justify-center rounded-full border border-[light-dark(#adb6c3,#48484f)] bg-[light-dark(#ffffff,#15151b)] p-0 font-[Arial,Helvetica,sans-serif] text-[light-dark(#14181e,#fff8f3)] [transition:background-color_.3s_ease,border-color_.32s_ease,box-shadow_.4s_cubic-bezier(.16,1,.3,1)] hover:border-[#f97316] hover:bg-[light-dark(#f0f2f5,#18181e)] hover:shadow-[inset_28px_0_34px_-28px_rgba(249,115,22,.62),inset_-28px_0_34px_-28px_rgba(249,115,22,.62),inset_0_0_18px_rgba(249,115,22,.08)] focus-visible:border-[#f97316] focus-visible:bg-[light-dark(#f0f2f5,#18181e)] focus-visible:shadow-[inset_28px_0_34px_-28px_rgba(249,115,22,.62),inset_-28px_0_34px_-28px_rgba(249,115,22,.62),inset_0_0_18px_rgba(249,115,22,.08)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-[5px] focus-visible:outline-[#f97316] motion-reduce:transition-none">
