...
import { definition as ReadMoreSwapDefinition } from "./read-more-swap/definition";
...
export const interactionDefinitions: Interaction[] = [
  ...
  OrangeCircleFillButtonDefinition,
  LayeredGradientButtonDefinition,
  GlowArrowButtonDefinition,
  TalkArrowRevealButtonDefinition,
