...
.floating-newsletter-button {
  ...
  background: light-dark(#f6f7f9,#0d0f12);
  padding: 18px 34px;
  color: light-dark(#14181e,#f5f5f7);
  font-size: 17px;
  font-weight: 400;
  line-height: 1.2;
  letter-spacing: -.3px;
...
.floating-newsletter-button:focus-visible {
  box-shadow:
    0 0 0 1px light-dark(rgba(20, 24, 30, .05), rgba(255, 255, 255, .05)),
    0 0 26px light-dark(rgba(20, 24, 30, .13), rgba(255, 255, 255, .13)),
    0 22px 34px light-dark(rgba(246, 247, 249, .32), rgba(0, 0, 0, .32));
}
...
.floating-newsletter-button:focus-visible {
  outline: 2px solid light-dark(rgba(20, 24, 30, .85), rgba(255, 255, 255, .85));
  outline-offset: 5px;
}
...
export const tailwindCode = `export function FloatingNewsletterButton() {
  return (
    <button
      type="button"
      className="group inline-flex cursor-pointer items-center justify-center rounded-full border-0 bg-[light-dark(#f6f7f9,#0d0f12)] px-[34px] py-[18px] text-[17px] font-normal leading-[1.2] tracking-[-.3px] text-[light-dark(#14181e,#f5f5f7)] transition-shadow duration-[420ms] ease-[cubic-bezier(.22,1,.36,1)] hover:shadow-[0_0_0_1px_rgba(255,255,255,.05),0_0_26px_rgba(255,255,255,.13),0_22px_34px_rgba(0,0,0,.32)] focus-visible:shadow-[0_0_0_1px_rgba(255,255,255,.05),0_0_26px_rgba(255,255,255,.13),0_22px_34px_rgba(0,0,0,.32)] focus-visible:outline-2 focus-visible:outline-offset-[5px] focus-visible:outline-white/85 motion-reduce:duration-[.01ms] max-[420px]:px-[26px] max-[420px]:py-[14px] max-[420px]:text-[15px]"
    >
