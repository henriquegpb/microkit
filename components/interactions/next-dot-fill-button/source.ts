...
.next-dot-fill-button {
  ...
  overflow: hidden;
  border: 1px solid light-dark(#3b434f,#d7dbe2);
  border-radius: 999px;
  background: light-dark(#14181e,#fff);
  padding: 0;
  color: light-dark(#f6f7f9,#0a0a0a);
...
.next-dot-fill-button__fill {
  ...
  height: 9px;
  border-radius: 50%;
  background: light-dark(#f6f7f9,#0a0a0a);
...
.next-dot-fill-button__reveal {
  ...
  justify-content: center;
  gap: 8px;
  color: light-dark(#14181e,#fafafa);
...
export function NextDotFillButton() {
  return (
    <button type="button" className="group relative inline-flex h-[50px] w-[min(132px,calc(100vw_-_40px))] cursor-pointer appearance-none items-center justify-center overflow-hidden rounded-full border border-[light-dark(#3b434f,#d7dbe2)] bg-white p-0 font-[Arial,Helvetica,sans-serif] text-base font-medium leading-none tracking-[-.02em] text-[light-dark(#f6f7f9,#0a0a0a)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#f97316]">
      <span className="absolute left-[26px] top-[calc(50%_-_4.5px)] z-[1] size-[9px] rounded-full bg-[light-dark(#f6f7f9,#0a0a0a)] transition-transform duration-500 ease-[cubic-bezier(.16,1,.3,1)] group-hover:scale-[28] group-focus-visible:scale-[28] motion-reduce:transition-none" aria-hidden="true" />
      ...
      <span className="absolute inset-0 z-[2] inline-flex translate-x-[46px] items-center justify-center gap-2 text-[light-dark(#14181e,#fafafa)] opacity-0 [transition:transform_.35s_cubic-bezier(.16,1,.3,1),opacity_.3s_ease] group-hover:translate-x-0 group-hover:opacity-100 group-focus-visible:translate-x-0 group-focus-visible:opacity-100 motion-reduce:transition-none" aria-hidden="true">
        Next
