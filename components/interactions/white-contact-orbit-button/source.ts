...
.white-contact-orbit-button-icon-surface { position: absolute; inset: 0; border-radius: inherit; background: light-dark(#f6f7f9,#111); transform: scale(0); transform-origin: center; transition: transform .42s cubic-bezier(.16, 1, .3, 1); }
...
.white-contact-orbit-button:focus-visible .white-contact-orbit-button-icon { color: light-dark(#14181e,#fff); transition-delay: .08s; }
...
.white-contact-orbit-button:focus-visible { outline: 2px solid light-dark(#14181e,#fff); outline-offset: 4px; }
...
export function WhiteContactOrbitButton() {
  return (
    <button type="button" className="group relative inline-flex h-[50px] w-[160px] cursor-pointer appearance-none items-center justify-center overflow-hidden rounded-full border-0 bg-white p-0 font-[Arial,Helvetica,sans-serif] text-[light-dark(#f6f7f9,#111)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-white">
      ...
      <span className="absolute right-2 grid size-[34px] place-items-center rounded-full text-[light-dark(#f6f7f9,#111)] transition-colors duration-[120ms] group-hover:text-white group-hover:delay-[80ms] group-focus-visible:text-white group-focus-visible:delay-[80ms] motion-reduce:transition-none">
        <span className="absolute inset-0 origin-center scale-0 rounded-[inherit] bg-[light-dark(#f6f7f9,#111)] transition-transform duration-[420ms] ease-[cubic-bezier(.16,1,.3,1)] group-hover:scale-100 group-focus-visible:scale-100 motion-reduce:transition-none" />
