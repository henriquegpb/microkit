...
.white-contact-orbit-button-icon-surface { position: absolute; inset: 0; border-radius: inherit; background: light-dark(#14181e,#111); transform: scale(0); transform-origin: center; transition: transform .42s cubic-bezier(.16, 1, .3, 1); }
...
.white-contact-orbit-button:focus-visible .white-contact-orbit-button-icon { color: light-dark(#ffffff,#fff); transition-delay: .08s; }
...
.white-contact-orbit-button:focus-visible { outline: 2px solid light-dark(#ffffff,#fff); outline-offset: 4px; }
