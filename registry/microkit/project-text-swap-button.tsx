export function ProjectTextSwapButton() {
  return (
    <button
      type="button"
      className="group relative inline-flex w-full max-w-44 cursor-pointer appearance-none box-border items-center justify-center overflow-hidden rounded-full border border-[light-dark(#14181e,#f0f0f0)] bg-transparent px-8 py-3 text-center text-[light-dark(#14181e,#f0f0f0)] [font-family:Arial,Helvetica,sans-serif] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#f97316]"
    >
